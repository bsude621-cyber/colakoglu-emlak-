// Chrome headless ile 5 slayt PNG export
// Kullanım: node export.mjs   →  ./out/01.png ... 05.png
...
console.log(`\n5 slayt PNG export → ${OUT_DIR}\n`);
for (let i = 1; i <= 5; i++) await shoot(i);
console.log('\n✓ Tamamlandı. IG\'ye 01→05 sırayla yükle.');
